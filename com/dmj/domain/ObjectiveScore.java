...
/* loaded from: ObjectiveScore.class */
public class ObjectiveScore implements Serializable {
    ...
    public ObjectiveScore(String questionNum, double questionScore, String studentId, String insertUser, String insertDate, String updateUser, String updateDate) {
    ...
    public ObjectiveScore(String id, String questionNum, double questionScore, String studentId, Integer examPaperNum, String answer, String qtype, String tag, String notToScore, String isModify, String insertUser, String insertDate, String updateUser, String updateDate, String description, Integer schoolNum, String classNum, String isDelete, String ext1, String ext2, String ext3, String isAppend, String yanswer, int page, Integer gradeNum, String schoolName, String studentName, double totalScore, String objItems, String examinationRoomNum, String examNum, String subjectNum, String className, double fullScore, double step, double frequency, int noscore, int upfullscore, int norecognized, String isException, double regScore, double avgScore, String regId, Long clipRegId, String ceStatus, double quesScorePer, String cRegId, String testingCentreId) {
        this.id = id;
        this.questionNum = questionNum;
        this.questionScore = questionScore;
        this.studentId = studentId;
    ...
    public Long getClipRegId() {
        return this.clipRegId;
    }

    public void setClipRegId(Long clipRegId) {
        this.clipRegId = clipRegId;
    }
